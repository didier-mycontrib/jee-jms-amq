...
public class InteractiveJmsTestWithMain {
	...
	public static void main(String[] args) {
	  try{
		...
		props.put("connectionFactory.ConnectionFactory", "tcp://localhost:5445"); //???
		props.put(Context.PROVIDER_URL, "tcp://localhost:5445"); //????
		props.put(Context.SECURITY_PRINCIPAL, "root");//username , "..."
		props.put(Context.SECURITY_CREDENTIALS, "password"); //"pwd", "..."
